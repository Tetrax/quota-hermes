...
class QuotaResult:
    ...
    # Structured money balance for prepaid providers (e.g. DeepSeek):
    # {"currency": "USD", "total": 9.16}. Lets the status bar show a $ amount
    # without inventing a percentage; optional, None for window-based providers.
